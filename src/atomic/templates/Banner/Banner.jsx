...
const Banner = () => (
    <Component width="100%" backgroundColor="white" padding="0 16px" margin="auto 0 0">
        <Container>
            <Box column align="center" width="100%" max="1030px" backgroundColor="white" shadow="md" padding="40px" margin="0 auto" position="relative" zIndex="1">
                <StaticImage src="../../../images/6-transgraniczny.png" />
                <Box column width="100%" max="664px" margin="32px 0 2">
                    <Text size="contentM" align="center" margin="0 0 32px">
                    ...
                    <Text size="contentM" align="center">
                        Zanim się zapiszecie koniecznie przeczytajcie regulamin.
                    </Text>
                </Box>
