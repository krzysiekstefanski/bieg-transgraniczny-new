      ...
      >
        {theme === "niepodleglosci" ? (
          ...
          <Box column width="100%" max="936px" margin="0 0 40px">
            ...
            <Text size="contentM" margin="0 0 8px" marginMD="0 0 16px">
              296 zawodników i zawodniczek ukończyło 8. Gryfiński Transgraniczny
              Festiwal Biegowy (piątek 03.05.2024 r.), z czego najwięcej bieg na
              10 km – 158 osób, półmaraton – 99 osób, a 10 km nordic walking –
              39 osób. Pogoda dopisała, aczkolwiek dla zawodników było troszkę
              za ciepło, a także wiaterek mógł sprawiać małe kłopoty.
            </Text>
            <Text size="contentM" margin="0 0 8px" marginMD="0 0 16px">
            ...
            <Text size="contentM" margin="0 0 8px" marginMD="0 0 16px">
              ...
              zabezpieczenie trasy – policja, służba medyczna, nasi partnerzy w
              Niemczech, instruktorzy z The Body Gryfino), bez których łatwo by
              nie było.
            </Text>
          </Box>
