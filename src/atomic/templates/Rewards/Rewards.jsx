            ...
            <Container position="relative" zIndex="1">
                <Box column width="100%">
                    ...
                    <Box column>
                        ...
                        <Box grow="1" gap="24px" wrap="wrap">
                            <Box grow="1" backgroundColor="white" borderWidth="1px" borderColor="grey90" radius="8px" padding="34px" onClick={() => handleClick("koszulka-przód", 1)}>
                                <StaticImage src="../../../images/koszulka-przod.png" />
                            </Box>
                            <Box grow="1" backgroundColor="white" borderWidth="1px" borderColor="grey90" radius="8px" padding="34px" onClick={() => handleClick("koszulka-tył", 1)}>
