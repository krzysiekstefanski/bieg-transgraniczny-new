...
const Heading = styled.h1`
  ...
  font-size: ${props =>
    props.size ? getSize(props.size).size : props.fontSize ?? "16px"};
  line-height: ${props =>
    props.size ? getSize(props.size).interline : props.interline ?? "24px"};
  font-weight: ${props =>
    props.size ? getSize(props.size).weight : props.weight ?? "400"};
  ...
  @media (max-width: 374px) {
    ...
    font-size: ${props =>
      props.size ? getSize(props.sizeXS).size : props.fontSizeXS};
    line-height: ${props =>
      props.size ? getSize(props.sizeXS).interline : props.interlineXS};
    font-weight: ${props =>
      props.size ? getSize(props.sizeXS).weight : props.weightXS};
  ...
  @media (min-width: 576px) {
    ...
    font-size: ${props =>
      props.size ? getSize(props.sizeSM).size : props.fontSizeSM};
    line-height: ${props =>
      props.size ? getSize(props.sizeSM).interline : props.interlineSM};
    font-weight: ${props =>
      props.size ? getSize(props.sizeSM).weight : props.weightSM};
  ...
  @media (min-width: 769px) {
    ...
    font-size: ${props =>
      props.size ? getSize(props.sizeMD).size : props.fontSizeMD};
    line-height: ${props =>
      props.size ? getSize(props.sizeMD).interline : props.interlineMD};
    font-weight: ${props =>
      props.size ? getSize(props.sizeMD).weight : props.weightMD};
  ...
  @media (min-width: 992px) {
    ...
    font-size: ${props =>
      props.size ? getSize(props.sizeLG).size : props.fontSizeLG};
    line-height: ${props =>
      props.size ? getSize(props.sizeLG).interline : props.interlineLG};
    font-weight: ${props =>
      props.size ? getSize(props.sizeLG).weight : props.weightLG};
  ...
  @media (min-width: 1280px) {
    ...
    font-size: ${props =>
      props.size ? getSize(props.sizeXL).size : props.fontSizeXL};
    line-height: ${props =>
      props.size ? getSize(props.sizeXL).interline : props.interlineXL};
    font-weight: ${props =>
      props.size ? getSize(props.sizeXL).weight : props.weightXL};
  ...
  @media (min-width: 1440px) {
    ...
    font-size: ${props =>
      props.size ? getSize(props.sizeXXL).size : props.fontSizeXXL};
    line-height: ${props =>
      props.size ? getSize(props.sizeXXL).interline : props.interlineXXL};
    font-weight: ${props =>
      props.size ? getSize(props.sizeXXL).weight : props.weightXXL};
  ...
  @media (min-width: 1920px) {
    ...
    font-size: ${props =>
      props.size ? getSize(props.sizeHD).size : props.fontSizeHD};
    line-height: ${props =>
      props.size ? getSize(props.sizeHD).interline : props.interlineHD};
    font-weight: ${props =>
      props.size ? getSize(props.sizeHD).weight : props.weightHD};
